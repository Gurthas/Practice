...
public class TCommonResultInfo implements org.apache.thrift.TBase<TCommonResultInfo, TCommonResultInfo._Fields>,
		java.io.Serializable, Cloneable, Comparable<TCommonResultInfo> {
	...
	static {
		schemes.put(StandardScheme.class, new TCommonResultInfoStandardSchemeFactory());
		schemes.put(TupleScheme.class, new TCommonResultInfoTupleSchemeFactory());
	}
	...
	static {
		...
		org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TCommonResultInfo.class, metaDataMap);
	}

	public TCommonResultInfo() {
	}

	public TCommonResultInfo(int code, String msg, String alert, String requestId) {
		this();
		this.code = code;
		setCodeIsSet(true);
		this.msg = msg;
	 ...
	 */
	public TCommonResultInfo(TCommonResultInfo other) {
	...
	public TCommonResultInfo deepCopy() {
		return new TCommonResultInfo(this);
	}
	...
	public TCommonResultInfo setCode(int code) {
		this.code = code;
		setCodeIsSet(true);
		return this;
	}
	...
	public TCommonResultInfo setMsg(String msg) {
		this.msg = msg;
		return this;
	}
	...
	public TCommonResultInfo setAlert(String alert) {
		this.alert = alert;
		return this;
	}
	...
	public TCommonResultInfo setRequestId(String requestId) {
		this.requestId = requestId;
		return this;
	}
	...
	public boolean equals(Object that) {
		if (that == null)
			return false;
		if (that instanceof TCommonResultInfo)
			return this.equals((TCommonResultInfo) that);
		return false;
	}

	public boolean equals(TCommonResultInfo that) {
		if (that == null)
			return false;
	...
	@Override
	public int compareTo(TCommonResultInfo other) {
	...
	public String toString() {
		StringBuilder sb = new StringBuilder("TCommonResultInfo(");
		boolean first = true;
	...
	private static class TCommonResultInfoStandardSchemeFactory implements SchemeFactory {
		public TCommonResultInfoStandardScheme getScheme() {
			return new TCommonResultInfoStandardScheme();
		}
	}

	private static class TCommonResultInfoStandardScheme extends StandardScheme<TCommonResultInfo> {

		public void read(org.apache.thrift.protocol.TProtocol iprot, TCommonResultInfo struct)
		...
		public void write(org.apache.thrift.protocol.TProtocol oprot, TCommonResultInfo struct)
				throws org.apache.thrift.TException {
			struct.validate();
	...
	private static class TCommonResultInfoTupleSchemeFactory implements SchemeFactory {
		public TCommonResultInfoTupleScheme getScheme() {
			return new TCommonResultInfoTupleScheme();
		}
	}

	private static class TCommonResultInfoTupleScheme extends TupleScheme<TCommonResultInfo> {

		@Override
		public void write(org.apache.thrift.protocol.TProtocol prot, TCommonResultInfo struct)
				throws org.apache.thrift.TException {
		...
		@Override
		public void read(org.apache.thrift.protocol.TProtocol prot, TCommonResultInfo struct)
				throws org.apache.thrift.TException {
