...
public class TResultRollbackCoupon implements org.apache.thrift.TBase<TResultRollbackCoupon, TResultRollbackCoupon._Fields>, java.io.Serializable, Cloneable, Comparable<TResultRollbackCoupon> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TResultRollbackCoupon");
  ...
  static {
    schemes.put(StandardScheme.class, new TResultRollbackCouponStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TResultRollbackCouponTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TResultRollbackCoupon.class, metaDataMap);
  }

  public TResultRollbackCoupon() {
  }
   ...
   */
  public TResultRollbackCoupon(TResultRollbackCoupon other) {
  ...
  public TResultRollbackCoupon deepCopy() {
    return new TResultRollbackCoupon(this);
  }
  ...
  public TResultRollbackCoupon setCode(int code) {
    this.code = code;
    setCodeIsSet(true);
    return this;
  }
  ...
  public TResultRollbackCoupon setErrorMsg(String errorMsg) {
    this.errorMsg = errorMsg;
    return this;
  }
  ...
  public TResultRollbackCoupon setAlert(String alert) {
    this.alert = alert;
    return this;
  }
  ...
  public TResultRollbackCoupon setRequestId(String requestId) {
    this.requestId = requestId;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TResultRollbackCoupon)
      return this.equals((TResultRollbackCoupon)that);
    return false;
  }

  public boolean equals(TResultRollbackCoupon that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TResultRollbackCoupon other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TResultRollbackCoupon(");
    boolean first = true;
  ...
  private static class TResultRollbackCouponStandardSchemeFactory implements SchemeFactory {
    public TResultRollbackCouponStandardScheme getScheme() {
      return new TResultRollbackCouponStandardScheme();
    }
  }

  private static class TResultRollbackCouponStandardScheme extends StandardScheme<TResultRollbackCoupon> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TResultRollbackCoupon struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TResultRollbackCoupon struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TResultRollbackCouponTupleSchemeFactory implements SchemeFactory {
    public TResultRollbackCouponTupleScheme getScheme() {
      return new TResultRollbackCouponTupleScheme();
    }
  }

  private static class TResultRollbackCouponTupleScheme extends TupleScheme<TResultRollbackCoupon> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TResultRollbackCoupon struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TResultRollbackCoupon struct) throws org.apache.thrift.TException {
