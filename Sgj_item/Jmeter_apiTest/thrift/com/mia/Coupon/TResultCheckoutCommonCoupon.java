...
public class TResultCheckoutCommonCoupon implements org.apache.thrift.TBase<TResultCheckoutCommonCoupon, TResultCheckoutCommonCoupon._Fields>, java.io.Serializable, Cloneable, Comparable<TResultCheckoutCommonCoupon> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TResultCheckoutCommonCoupon");
  ...
  private static final org.apache.thrift.protocol.TField RESULT_INFO_FIELD_DESC = new org.apache.thrift.protocol.TField("resultInfo", org.apache.thrift.protocol.TType.STRUCT, (short)5);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new TResultCheckoutCommonCouponStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TResultCheckoutCommonCouponTupleSchemeFactory());
  }
  ...
  public TContent resultInfo; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    RESULT_INFO((short)5, "resultInfo");
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TResultCheckoutCommonCoupon.class, metaDataMap);
  }

  public TResultCheckoutCommonCoupon() {
  }
   ...
   */
  public TResultCheckoutCommonCoupon(TResultCheckoutCommonCoupon other) {
  ...
  public TResultCheckoutCommonCoupon deepCopy() {
    return new TResultCheckoutCommonCoupon(this);
  }
  ...
  public TResultCheckoutCommonCoupon setCode(int code) {
    this.code = code;
    setCodeIsSet(true);
    return this;
  }
  ...
  public TResultCheckoutCommonCoupon setErrorMsg(String errorMsg) {
    this.errorMsg = errorMsg;
    return this;
  }
  ...
  public TResultCheckoutCommonCoupon setAlert(String alert) {
    this.alert = alert;
    return this;
  }
  ...
  public TResultCheckoutCommonCoupon setRequestId(String requestId) {
    this.requestId = requestId;
    return this;
  }
  ...
  public TContent getResultInfo() {
    return this.resultInfo;
  }

  public TResultCheckoutCommonCoupon setResultInfo(TContent resultInfo) {
    this.resultInfo = resultInfo;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TResultCheckoutCommonCoupon)
      return this.equals((TResultCheckoutCommonCoupon)that);
    return false;
  }

  public boolean equals(TResultCheckoutCommonCoupon that) {
    if (that == null)
      return false;
  ...
  public int hashCode() {
    ...
    boolean present_resultInfo = true && (isSetResultInfo());
  ...
  @Override
  public int compareTo(TResultCheckoutCommonCoupon other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TResultCheckoutCommonCoupon(");
    boolean first = true;
  ...
  private static class TResultCheckoutCommonCouponStandardSchemeFactory implements SchemeFactory {
    public TResultCheckoutCommonCouponStandardScheme getScheme() {
      return new TResultCheckoutCommonCouponStandardScheme();
    }
  }

  private static class TResultCheckoutCommonCouponStandardScheme extends StandardScheme<TResultCheckoutCommonCoupon> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TResultCheckoutCommonCoupon struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 5: // RESULT_INFO
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.resultInfo = new TContent();
              struct.resultInfo.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TResultCheckoutCommonCoupon struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TResultCheckoutCommonCouponTupleSchemeFactory implements SchemeFactory {
    public TResultCheckoutCommonCouponTupleScheme getScheme() {
      return new TResultCheckoutCommonCouponTupleScheme();
    }
  }

  private static class TResultCheckoutCommonCouponTupleScheme extends TupleScheme<TResultCheckoutCommonCoupon> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TResultCheckoutCommonCoupon struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TResultCheckoutCommonCoupon struct) throws org.apache.thrift.TException {
