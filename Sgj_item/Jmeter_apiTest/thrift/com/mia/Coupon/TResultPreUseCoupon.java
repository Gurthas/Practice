...
public class TResultPreUseCoupon implements org.apache.thrift.TBase<TResultPreUseCoupon, TResultPreUseCoupon._Fields>, java.io.Serializable, Cloneable, Comparable<TResultPreUseCoupon> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TResultPreUseCoupon");
  ...
  static {
    schemes.put(StandardScheme.class, new TResultPreUseCouponStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TResultPreUseCouponTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TResultPreUseCoupon.class, metaDataMap);
  }

  public TResultPreUseCoupon() {
  }
   ...
   */
  public TResultPreUseCoupon(TResultPreUseCoupon other) {
  ...
  public TResultPreUseCoupon deepCopy() {
    return new TResultPreUseCoupon(this);
  }
  ...
  public TResultPreUseCoupon setCode(int code) {
    this.code = code;
    setCodeIsSet(true);
    return this;
  }
  ...
  public TResultPreUseCoupon setErrorMsg(String errorMsg) {
    this.errorMsg = errorMsg;
    return this;
  }
  ...
  public TResultPreUseCoupon setAlert(String alert) {
    this.alert = alert;
    return this;
  }
  ...
  public TResultPreUseCoupon setRequestId(String requestId) {
    this.requestId = requestId;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TResultPreUseCoupon)
      return this.equals((TResultPreUseCoupon)that);
    return false;
  }

  public boolean equals(TResultPreUseCoupon that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TResultPreUseCoupon other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TResultPreUseCoupon(");
    boolean first = true;
  ...
  private static class TResultPreUseCouponStandardSchemeFactory implements SchemeFactory {
    public TResultPreUseCouponStandardScheme getScheme() {
      return new TResultPreUseCouponStandardScheme();
    }
  }

  private static class TResultPreUseCouponStandardScheme extends StandardScheme<TResultPreUseCoupon> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TResultPreUseCoupon struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TResultPreUseCoupon struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TResultPreUseCouponTupleSchemeFactory implements SchemeFactory {
    public TResultPreUseCouponTupleScheme getScheme() {
      return new TResultPreUseCouponTupleScheme();
    }
  }

  private static class TResultPreUseCouponTupleScheme extends TupleScheme<TResultPreUseCoupon> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TResultPreUseCoupon struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TResultPreUseCoupon struct) throws org.apache.thrift.TException {
