...
public class QueryParam implements org.apache.thrift.TBase<QueryParam, QueryParam._Fields>, java.io.Serializable, Cloneable, Comparable<QueryParam> {
  ...
  private static final org.apache.thrift.protocol.TField UIDS_FIELD_DESC = new org.apache.thrift.protocol.TField("uids", org.apache.thrift.protocol.TType.LIST, (short)4);
  private static final org.apache.thrift.protocol.TField ADD_NEWS_INFO_FIELD_DESC = new org.apache.thrift.protocol.TField("addNewsInfo", org.apache.thrift.protocol.TType.STRUCT, (short)5);
  ...
  public AppNewsInfo addNewsInfo; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    UIDS((short)4, "uids"),
    ADD_NEWS_INFO((short)5, "addNewsInfo");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 4: // UIDS
          return UIDS;
        case 5: // ADD_NEWS_INFO
          return ADD_NEWS_INFO;
        default:
          return null;
      }
    }
  ...
  static {
    ...
    tmpMap.put(_Fields.UIDS, new org.apache.thrift.meta_data.FieldMetaData("uids", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32))));
    tmpMap.put(_Fields.ADD_NEWS_INFO, new org.apache.thrift.meta_data.FieldMetaData("addNewsInfo", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, AppNewsInfo.class)));
  ...
  public QueryParam(QueryParam other) {
    ...
    if (other.isSetAddNewsInfo()) {
      this.addNewsInfo = new AppNewsInfo(other.addNewsInfo);
    }
  }
  ...
  public QueryParam setUids(List<Integer> uids) {
    this.uids = uids;
    return this;
  }
  ...
  public AppNewsInfo getAddNewsInfo() {
    return this.addNewsInfo;
  }

  public QueryParam setAddNewsInfo(AppNewsInfo addNewsInfo) {
    this.addNewsInfo = addNewsInfo;
    return this;
  }

  public void unsetAddNewsInfo() {
    this.addNewsInfo = null;
  }

  /** Returns true if field addNewsInfo is set (has been assigned a value) and false otherwise */
  public boolean isSetAddNewsInfo() {
    return this.addNewsInfo != null;
  }

  public void setAddNewsInfoIsSet(boolean value) {
    if (!value) {
      this.addNewsInfo = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ADD_NEWS_INFO:
      if (value == null) {
        ...
        setAddNewsInfo((AppNewsInfo)value);
      }
      break;
  ...
  public boolean equals(QueryParam that) {
    ...
    boolean this_present_addNewsInfo = true && this.isSetAddNewsInfo();
    boolean that_present_addNewsInfo = true && that.isSetAddNewsInfo();
    if (this_present_addNewsInfo || that_present_addNewsInfo) {
      if (!(this_present_addNewsInfo && that_present_addNewsInfo))
        return false;
      if (!this.addNewsInfo.equals(that.addNewsInfo))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_addNewsInfo = true && (isSetAddNewsInfo());
    list.add(present_addNewsInfo);
    if (present_addNewsInfo)
      list.add(addNewsInfo);
  ...
  public int compareTo(QueryParam other) {
    ...
    lastComparison = Boolean.valueOf(isSetAddNewsInfo()).compareTo(other.isSetAddNewsInfo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAddNewsInfo()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.addNewsInfo, other.addNewsInfo);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("addNewsInfo:");
    if (this.addNewsInfo == null) {
      sb.append("null");
    } else {
      sb.append(this.addNewsInfo);
    }
    first = false;
    sb.append(")");
    return sb.toString();
  ...
  private static class QueryParamStandardScheme extends StandardScheme<QueryParam> {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.uids = new ArrayList<Integer>(_list0.size);
                int _elem1;
          ...
          case 5: // ADD_NEWS_INFO
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.addNewsInfo = new AppNewsInfo();
              struct.addNewsInfo.read(iprot);
              struct.setAddNewsInfoIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, QueryParam struct) throws org.apache.thrift.TException {
      ...
      if (struct.addNewsInfo != null) {
        oprot.writeFieldBegin(ADD_NEWS_INFO_FIELD_DESC);
        struct.addNewsInfo.write(oprot);
        oprot.writeFieldEnd();
      }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.uids = new ArrayList<Integer>(_list5.size);
          int _elem6;
