...
public class PublicParam {
	...
	public static Map<String, String> mapparam(int loginFlag, String params, String app_id, String versionId,
			String auth_session) {
		uid = uuid();
		sessionid = sessionid();
		seconds = seconds();
		String version = Method.Transform(app_id) + "_" + versionId;
		String app = Method.Transform(app_id) + "_test_id";
		...
		if (loginFlag == 1) {
			map.put("auth_session", auth_session);
		} else {
