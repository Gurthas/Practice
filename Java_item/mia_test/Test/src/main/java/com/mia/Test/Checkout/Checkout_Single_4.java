...
public class Checkout_Single_4 {
	private static Logger log = LogManager.getLogger("Checkout_Single_4");
	...
	@Test(description="checckout_普通单品结算_4",groups = { "checkout", "checkout_single" })
	public static void Test() {
		...
		//判断优惠金额
		Assert.assertEquals("20",reduce_price);
		//判断售卖金额
		Assert.assertEquals("180",pay_price);
