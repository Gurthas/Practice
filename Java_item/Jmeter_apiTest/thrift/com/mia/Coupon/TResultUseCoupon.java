...
public class TResultUseCoupon implements org.apache.thrift.TBase<TResultUseCoupon, TResultUseCoupon._Fields>, java.io.Serializable, Cloneable, Comparable<TResultUseCoupon> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TResultUseCoupon");
  ...
  static {
    schemes.put(StandardScheme.class, new TResultUseCouponStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TResultUseCouponTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TResultUseCoupon.class, metaDataMap);
  }

  public TResultUseCoupon() {
  }
   ...
   */
  public TResultUseCoupon(TResultUseCoupon other) {
  ...
  public TResultUseCoupon deepCopy() {
    return new TResultUseCoupon(this);
  }
  ...
  public TResultUseCoupon setCode(int code) {
    this.code = code;
    setCodeIsSet(true);
    return this;
  }
  ...
  public TResultUseCoupon setErrorMsg(String errorMsg) {
    this.errorMsg = errorMsg;
    return this;
  }
  ...
  public TResultUseCoupon setAlert(String alert) {
    this.alert = alert;
    return this;
  }
  ...
  public TResultUseCoupon setRequestId(String requestId) {
    this.requestId = requestId;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TResultUseCoupon)
      return this.equals((TResultUseCoupon)that);
    return false;
  }

  public boolean equals(TResultUseCoupon that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TResultUseCoupon other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TResultUseCoupon(");
    boolean first = true;
  ...
  private static class TResultUseCouponStandardSchemeFactory implements SchemeFactory {
    public TResultUseCouponStandardScheme getScheme() {
      return new TResultUseCouponStandardScheme();
    }
  }

  private static class TResultUseCouponStandardScheme extends StandardScheme<TResultUseCoupon> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TResultUseCoupon struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TResultUseCoupon struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TResultUseCouponTupleSchemeFactory implements SchemeFactory {
    public TResultUseCouponTupleScheme getScheme() {
      return new TResultUseCouponTupleScheme();
    }
  }

  private static class TResultUseCouponTupleScheme extends TupleScheme<TResultUseCoupon> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TResultUseCoupon struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TResultUseCoupon struct) throws org.apache.thrift.TException {
