...
public class TParamsRollbackCoupon implements org.apache.thrift.TBase<TParamsRollbackCoupon, TParamsRollbackCoupon._Fields>, java.io.Serializable, Cloneable, Comparable<TParamsRollbackCoupon> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TParamsRollbackCoupon");
  ...
  static {
    schemes.put(StandardScheme.class, new TParamsRollbackCouponStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TParamsRollbackCouponTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TParamsRollbackCoupon.class, metaDataMap);
  }

  public TParamsRollbackCoupon() {
  }
   ...
   */
  public TParamsRollbackCoupon(TParamsRollbackCoupon other) {
  ...
  public TParamsRollbackCoupon deepCopy() {
    return new TParamsRollbackCoupon(this);
  }
  ...
  public TParamsRollbackCoupon setUid(int uid) {
    this.uid = uid;
    setUidIsSet(true);
    return this;
  }
  ...
  public TParamsRollbackCoupon setCkSuperiorOrderCode(String ckSuperiorOrderCode) {
    this.ckSuperiorOrderCode = ckSuperiorOrderCode;
    return this;
  }
  ...
  public TParamsRollbackCoupon setCouponCodes(List<String> couponCodes) {
    this.couponCodes = couponCodes;
    return this;
  }
  ...
  public TParamsRollbackCoupon setOpUser(String opUser) {
    this.opUser = opUser;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TParamsRollbackCoupon)
      return this.equals((TParamsRollbackCoupon)that);
    return false;
  }

  public boolean equals(TParamsRollbackCoupon that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TParamsRollbackCoupon other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TParamsRollbackCoupon(");
    boolean first = true;
  ...
  private static class TParamsRollbackCouponStandardSchemeFactory implements SchemeFactory {
    public TParamsRollbackCouponStandardScheme getScheme() {
      return new TParamsRollbackCouponStandardScheme();
    }
  }

  private static class TParamsRollbackCouponStandardScheme extends StandardScheme<TParamsRollbackCoupon> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TParamsRollbackCoupon struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.couponCodes = new ArrayList<String>(_list8.size);
                String _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = iprot.readString();
                  struct.couponCodes.add(_elem9);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TParamsRollbackCoupon struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.couponCodes != null) {
        oprot.writeFieldBegin(COUPON_CODES_FIELD_DESC);
        {
          ...
          for (String _iter11 : struct.couponCodes)
          {
  ...
  private static class TParamsRollbackCouponTupleSchemeFactory implements SchemeFactory {
    public TParamsRollbackCouponTupleScheme getScheme() {
      return new TParamsRollbackCouponTupleScheme();
    }
  }

  private static class TParamsRollbackCouponTupleScheme extends TupleScheme<TParamsRollbackCoupon> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TParamsRollbackCoupon struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetCouponCodes()) {
        {
          ...
          for (String _iter12 : struct.couponCodes)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TParamsRollbackCoupon struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.couponCodes = new ArrayList<String>(_list13.size);
          String _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = iprot.readString();
            struct.couponCodes.add(_elem14);
          }
        }
        struct.setCouponCodesIsSet(true);
      }
