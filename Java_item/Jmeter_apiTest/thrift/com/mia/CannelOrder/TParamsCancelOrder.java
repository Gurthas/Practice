...
public class TParamsCancelOrder implements org.apache.thrift.TBase<TParamsCancelOrder, TParamsCancelOrder._Fields>, java.io.Serializable, Cloneable, Comparable<TParamsCancelOrder> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TParamsCancelOrder");
  ...
  static {
    schemes.put(StandardScheme.class, new TParamsCancelOrderStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TParamsCancelOrderTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TParamsCancelOrder.class, metaDataMap);
  }

  public TParamsCancelOrder() {
  }
   ...
   */
  public TParamsCancelOrder(TParamsCancelOrder other) {
  ...
  public TParamsCancelOrder deepCopy() {
    return new TParamsCancelOrder(this);
  }
  ...
  public TParamsCancelOrder setUserId(int userId) {
    this.userId = userId;
    setUserIdIsSet(true);
    return this;
  }
  ...
  public TParamsCancelOrder setSuperiorOrderCode(String superiorOrderCode) {
    this.superiorOrderCode = superiorOrderCode;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TParamsCancelOrder)
      return this.equals((TParamsCancelOrder)that);
    return false;
  }

  public boolean equals(TParamsCancelOrder that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TParamsCancelOrder other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TParamsCancelOrder(");
    boolean first = true;
  ...
  private static class TParamsCancelOrderStandardSchemeFactory implements SchemeFactory {
    public TParamsCancelOrderStandardScheme getScheme() {
      return new TParamsCancelOrderStandardScheme();
    }
  }

  private static class TParamsCancelOrderStandardScheme extends StandardScheme<TParamsCancelOrder> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TParamsCancelOrder struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TParamsCancelOrder struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TParamsCancelOrderTupleSchemeFactory implements SchemeFactory {
    public TParamsCancelOrderTupleScheme getScheme() {
      return new TParamsCancelOrderTupleScheme();
    }
  }

  private static class TParamsCancelOrderTupleScheme extends TupleScheme<TParamsCancelOrder> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TParamsCancelOrder struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TParamsCancelOrder struct) throws org.apache.thrift.TException {
